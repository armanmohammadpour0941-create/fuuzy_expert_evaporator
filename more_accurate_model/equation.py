...
def med_equation(t, x, u, distur, params, time_vec):
    ...
    Q_e = w_s * lambda_s
    w_v_t = ((Q_e) + (w_f * cp_f * (t_f - boiling_temp))) / lambda_v
    ...
    l_next = 0  # level of next effect
    rho_next = rho_b + 5.0  # density of next level
    v_2 = (
        2.0
        * G
        * (
    ...
    x_fp = w_f * x_f / (w_f - w_v_t)
    x_binp = w_bin * x_bin / (w_bin - w_v_f)
