...
def evaporator_dynamic_model(t, x, u, d):
    ...
    # if t > 180:
        ...
        # T_f = 30  # feed temperature drops to 30°C after 180 seconds
        ...
        # #input changes
        # W_s = 30  # steam flow rate drops to 30 kg/s after 180 seconds
    ...
    Cp_s = 2.0         # specific heat capacity of steam (kJ/kg°C)
    ...
    V_film = (Q_steam - W_f * Cp * abs((T_effect - T_f))) / lambda_eff
    ...
    Q_in = Q_steam + W_f * Cp * T_f  + W_bin * Cp * T_bin 
    Q_out = W_bout * Cp * T_effect + (V_film + v_bp) * lambda_eff
    dT_effect_dt = (Q_in - Q_out) / (M_bp * Cp_s)
